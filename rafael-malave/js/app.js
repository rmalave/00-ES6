...
function displayPics(){
  ...
  // The reason the error was thrown was because constiables declared by const have as their scope the block in which they are defined, as well as in any contained sub-blocks and
  // the console.log is trying to reference rando from outsite it's scope.
  console.log(viewed);
